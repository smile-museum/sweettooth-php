...
class SweetTooth_Object implements ArrayAccess
{
  ...
  public function __construct($id=null, $apiKey=null)
  {
    $this->_apiKey = $apiKey;
    $this->_values = array();
    $this->_unsavedValues = new SweetTooth_Util_Set();
    $this->_transientValues = new SweetTooth_Util_Set();
  ...
  public function __get($k)
  {
    if (array_key_exists($k, $this->_values)) {
      ...
      error_log("SweetTooth Notice: Undefined property of $class instance: $k.  HINT: The $k attribute was set in the past, however.  It was then wiped when refreshing the object with the result returned by SweetTooth's API, probably as a result of a save().  The attributes currently available on this object are: $attrs");
      return null;
    } else {
      $class = get_class($this);
      error_log("SweetTooth Notice: Undefined property of $class instance: $k");
      return null;
    }
  }
  ...
  public function serializeParameters()
  {
    ...
    foreach (self::$_nestedUpdatableAttributes->toArray() as $property) {
      if (isset($this->$property) && $this->$property instanceOf SweetTooth_Object) {
